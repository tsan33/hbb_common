...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "dpc28".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["8.210.12.5"];
pub const RS_PUB_KEY: &str = "Oo0NnBINil4SIk58yK1x4rJXKnwgk9NIa4t0zK0rtOU=";
